                    ...
                    <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-lg ">
                                    ...
                                    <tbody>
                                        @php $price_column =0; $price_column_total=0; $total_absolute_cheapest=0; @endphp
                                                ...
                                                <th scope="row" >
                                                    ...
                                                    @for($pro_name=0; $pro_name<count($fianl[$j]); $pro_name++)
                                                        @if(isset($fianl[$j][$pro_name]['name']))
                                                            ...
                                                            @php $product_name = $fianl[$j][$pro_name]['name']; @endphp
                                                ...
                                                <th class="text-center">
													<table class="w-100">
														<tbody>
                                                            ...
                                                            ?>
															@php $cheap = \App\Http\Controllers\ProductController::getAbsoluteCheapest($shop_id,$shop_name);
															...
															@endphp
																...
																<td style="width: 50%;">
                                                                @if($cheap['shop']!='')
																	<img src='<?php echo asset("uploads/".$cheap['shop']->image) ?>' width="25" data-toggle="tooltip" data-placement="top" title="<?php echo $cheap['shop']->address;?>" style="width: 25px;height: 25px;object-fit: cover;">
																@endif
                                                                </td>
															</tr>
														</tbody>
