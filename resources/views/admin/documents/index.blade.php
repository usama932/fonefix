		  ...
		  <div class="modal-dialog modal-dialog-centered" role="document">
			  <div class="modal-content">
				  <div class="modal-header">
					  ...
					  <h4 class="modal-title" id="myModalLabel">Document Detail</h4> </div>
  ...
  <script>
      ...
      var users = $('#users').DataTable( {
          ...
          "columns":[
              ...
              {"data":"name"},
              {"data":"description"},
              {"data":"folder_id","searchable":false,"orderable":false},
              {"data":"created_at"},
      ...
      function viewInfo(id) {
          ...
          $.get("{{ route('admin.getDocument') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
      ...
      function del(id){
          ...
          icon: "warning",
              ...
              if (result.value) {
                  ...
                  window.location.href = APP_URL+"/admin/document/delete/"+id;
              }
          });
      }
