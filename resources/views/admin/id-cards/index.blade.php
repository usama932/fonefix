  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Id Card List</h3>
      ...
      <div class="card-toolbar">
        ...
        <!--begin::Button-->
        <a href="{{ route('id-cards.create') }}" class="btn btn-primary font-weight-bolder">
    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
	      <form action="{{route('admin.delete-selected-id-cards')}}" method="post" id="client_form">
		  ...
		  <div class="modal-dialog modal-dialog-centered" role="document">
			  <div class="modal-content">
				  <div class="modal-header">
					  ...
					  <h4 class="modal-title" id="myModalLabel">Id Card Detail</h4> </div>
...
@section('scripts')
  ...
  <script>
      ...
      function viewInfo(id) {
          ...
          $.post("{{ route('admin.getIdCard') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
      ...
      function del(id){
          ...
          icon: "warning",
              ...
              if (result.value) {
                  Swal.fire(
                      "Deleted!",
                      "Your IdCard has been deleted.",
                      "success"
                  );
                  var APP_URL = {!! json_encode(url('/')) !!}
                  window.location.href = APP_URL+"/admin/id-card/delete/"+id;
              }
          });
      }
