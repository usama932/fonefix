...
<div id="kt_header" class="header header-fixed">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        @php
            if(Auth::user()->role == 1){
                  $products = \App\Models\Product::where([["manage_stock",1]])->whereRaw('quantity <= alert_quantity')->get();
              }elseif(Auth::user()->role == 2){
                  $products = \App\Models\Product::where([["manage_stock",1],["user_id",Auth::id()]])
                      ->whereRaw('quantity <= alert_quantity')->get();
                  $emails = Auth::user()->number_of_emails;
                  $jobs = Auth::user()->number_of_jobs;
                  $sms = Auth::user()->number_of_sms;
                  $whatsapp = Auth::user()->number_of_whatsapp;
                  ...
                  $products = \App\Models\Product::where([["manage_stock",1],["user_id",Auth::user()->parent_id]])->whereRaw('quantity <= alert_quantity')->get();
                    $emails = Auth::user()->shop->number_of_emails;
                  $jobs = Auth::user()->shop->number_of_jobs;
                  $sms = Auth::user()->shop->number_of_sms;
                  $whatsapp = Auth::user()->shop->number_of_whatsapp;
                  $now = time(); // or your date as well
        ...
        @if(Auth::user()->role != 1)
            <div class="bg-dark p-7">
                <span class="text-white mr-5">
                    SMS Left : <span class="text-primary ">{{$sms}}</span>
                </span>
                <span class="text-white mr-5">
                    Email Left : <span class="text-primary ">{{$emails}}</span>
                </span>
                <span class="text-white mr-5">
                    JobSheet Left :  <span class="text-primary ">{{$jobs}}</span>
                </span>
                <span class="text-white mr-5">
                    Whatsapp Left : <span class="text-primary ">{{$whatsapp}}</span>
                </span>
                <span class="text-white mr-5">
                    Expiry Days Left : <span class="text-primary ">{{$expiry}}</span>
                </span>
            </div>
        @endif
                    ...
                    <!--begin::Header-->
                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url({{asset("assets/media/misc/bg-1.jpg")}})">
                            ...
                            <h4 class="d-flex flex-center rounded-top">
                                <span class="text-white">Out Of Stock Notifications</span>
                                <span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2">{{$products->count()}} new</span>
                            </h4>
                            <!--end::Title-->
                            <!--begin::Tabs-->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
                                    ...
                                    @foreach($products as $product)
                                        <div class="d-flex align-items-center mb-6">
                                            ...
                                            <div class="d-flex flex-column font-weight-bold">
                                                <a href="{{route("products.edit",$product->id)}}" class="text-dark text-hover-primary mb-1 font-size-lg">{{$product->name}}</a>
                                                @if($product->cateogry_id)
                                                    <span class="text-muted">{{$product->cateogry->name}}</span>
                                                @endif
                                            </div>
                                            <!--end::Text-->
                                        </div>
                                ...
                                {{--                                                        </div>--}}
                                <!--end::Item-->
                                    <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; right: 0px; height: 300px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 203px;"></div></div></div>
                                <!--end::Scroll-->
                                <!--begin::Action-->
                                <div class="d-flex flex-center pt-7">
                                    <a href="{{route("products.index")}}" class="btn btn-light-primary font-weight-bold text-center">See All Products</a>
                                </div>
                                <!--end::Action-->
                            </div>
                            <!--end::Tabpane-->
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px" aria-expanded="false">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1 pulse pulse-primary">
											<span class="svg-icon svg-icon-xl svg-icon-primary">
												<!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Code/Compiling.svg-->
												<span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Clothes/Briefcase.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg" style="">
                    ...
                    @php
                        ...
                        $today = date('Y-m-d', strtotime($today . ' + 1 day'));
                            if(Auth::user()->role == 1){
                                  $jobs = \App\Models\Job::where([["expected_delivery","<=",$today]])
                                  ->join('statuses', function ($join)  {
                                        $join->on('statuses.id', '=', 'jobs.status_id')
                                            ->where('statuses.complete', '!=', 1);
                                    })
                                    ->select(
                                        'jobs.*'
                                    )
                                  ->get();
                                $enquiries = \App\Models\Enquiry::where([["estimate_date","<=",$today],["status","!=",1]])->get();
                              }elseif(Auth::user()->role == 2){
                                    $enquiries = \App\Models\Enquiry::where([["estimate_date","<=",$today],["status","!=",1],["user_id",Auth::id()]])->get();
                                  $jobs = \App\Models\Job::where([["expected_delivery","<=",$today],["jobs.user_id",Auth::id()]])
                                      ->join('statuses', function ($join)  {
                                        $join->on('statuses.id', '=', 'jobs.status_id')
                                            ->where('statuses.complete', '!=', 1);
                                    })
                                  ...
                                  ->get();
                                    ...
                                    $enquiries = \App\Models\Enquiry::where([["estimate_date","<=",$today],["status","!=",1],["user_id",Auth::user()->parent_id]])->get();
                                  $jobs = \App\Models\Job::where([["expected_delivery","<=",$today],["jobs.user_id",Auth::user()->parent_id]])
                                  ->join('statuses', function ($join)  {
                                        $join->on('statuses.id', '=', 'jobs.status_id')
                                            ->where('statuses.complete', '!=', 1);
                                    })
                    ...
                    <!--begin::Header-->
                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url({{asset("assets/media/misc/bg-1.jpg")}})">
                            <!--begin::Title-->
                            <h4 class="d-flex flex-center rounded-top">
                                <span class="text-white">Pending Job Sheet / Enquiries</span>
                                <span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2">{{$jobs->count()+$enquiries->count()}} new</span>
                            </h4>
                            <!--end::Title-->
                            <!--begin::Tabs-->
                        {{--                                                <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8" role="tablist">--}}
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
                                ...
                                <div class="scroll pr-7 mr-n7 ps" data-scroll="true" data-height="300" data-mobile-height="200" style="height: 300px; overflow: hidden;">
                                    ...
                                    @foreach($jobs as $job)
                                        <div class="d-flex align-items-center mb-6">
                                            ...
                                            <!--begin::Text-->
                                            <div class="d-flex flex-column font-weight-bold">
                                                <a href="{{route("jobs.edit",$job->id)}}" class="text-dark text-hover-primary mb-1 font-size-lg">{{$job->job_sheet_number}}</a>
                                ...
                                @endforeach
                                    @foreach($enquiries as $enquiry)
                                        <div class="d-flex align-items-center mb-6">
                                            ...
                                            <!--begin::Text-->
                                            <div class="d-flex flex-column font-weight-bold">
                                                <a href="{{route("enquiries.edit",$enquiry->id)}}" class="text-dark text-hover-primary mb-1 font-size-lg">Enquiry #{{$enquiry->id}}</a>
                                ...
                                <!--begin::Action-->
                                <div class="d-flex flex-center pt-7">
                                    <a href="{{route("jobs.index")}}" class="btn btn-light-primary font-weight-bold text-center">See All Jobs</a>
                                </div>
                                <!--end::Action-->
                            </div>
                            <!--end::Tabpane-->
