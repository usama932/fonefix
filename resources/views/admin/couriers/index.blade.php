  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Couriers List</h3>
      ...
      <div class="card-toolbar">
        ...
        <!--begin::Button-->
        <a href="{{ route('couriers.create') }}" class="btn btn-primary font-weight-bolder">
    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
	      <form action="{{route('admin.delete-selected-couriers')}}" method="post" id="client_form">
		  ...
		  <div class="modal-dialog modal-dialog-centered" role="document">
			  <div class="modal-content">
				  <div class="modal-header">
					  ...
					  <h4 class="modal-title" id="myModalLabel">Courier Detail</h4> </div>
...
@section('scripts')
  ...
  <script>
      ...
      function viewInfo(id) {
          ...
          $.post("{{ route('admin.getCourier') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
      ...
      function del(id){
          ...
          icon: "warning",
              ...
              if (result.value) {
                  ...
                  window.location.href = APP_URL+"/admin/courier/delete/"+id;
              }
          });
      }
      function del_selected(){
          Swal.fire({
              ...
              if (result.value) {
                  Swal.fire(
                      "Deleted!",
                      "Your Couriers has been deleted.",
                      "success"
                  );
                  $("#client_form").submit();
              }
