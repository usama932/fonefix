         ...
         <div class="card card-custom card-sticky" id="kt_page_sticky_card">
            <div class="card-header" style="">
               <div class="card-title">
                  <h3 class="card-label">Enquiry Add Form
                     <i class="mr-2"></i>
            ...
            <div class="card-body">
               ...
               <!--begin::Form-->
               {{ Form::open([ 'route' => 'enquiries.store','class'=>'form' ,"id"=>"client_add_form", 'enctype'=>'multipart/form-data']) }}
               @csrf
                     ...
                     <div class="my-5">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-3">
                              ...
                              <label><input type="checkbox" id="status" name="status" value="1">
                              <span></span>
                              </label>
                              </span>
                           </div>
