...
<div class="card card-custom">
   <div class="card-header">
      <div class="card-title">
         ...
         <h3 class="card-label">Enquiries List</h3>
         @if(auth()->user()->role == '1')
      ...
      <div class="card-toolbar">
         ...
         $add = $user->permission->enquiries_add;
         }
         @endphp
         @if($add)
         <!--begin::Button-->
         ...
         <a href="{{ route('enquiries.create') }}" class="btn btn-primary mr-2 font-weight-bolder">
         ...
         @endif
         <div class="btn-group">
            <a href="{{ route('enquiry-import') }}"  class="btn btn-success font-weight-bolder">
            <i class="fa fa-file-import icon-sm"></i>Import</a>
            <a href="{{ route('enquiry-export') }}"  id="kt_btn" class="btn btn-primary font-weight-bolder">
   ...
   <div class="card-body">
      ...
      <div class="table-responsive">
         <form action="{{route('admin.delete-selected-enquiries')}}" method="post" id="client_form">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
         <div class="modal-content">
            <div class="modal-header">
               ...
               <h4 class="modal-title" id="myModalLabel">Enquiry Detail</h4>
            </div>
...
<script>
   ...
   var clients = $('#clients').DataTable( {
       ...
       "columns":[
           ...
           {"data":"completed_at","searchable":false,"orderable":false},
           @if($user->role == 1)
   ...
   function viewInfo(id) {
       ...
       $.post("{{ route('admin.getEnquiry') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
   ...
   function del(id){
       ...
       icon: "warning",
           ...
           if (result.value) {
               ...
               window.location.href = APP_URL+"/admin/enquiry/delete/"+id;
           }
       });
   }
   function del_selected(){
       Swal.fire({
           ...
           if (result.value) {
               Swal.fire(
                   "Deleted!",
                   "Your Enquiries has been deleted.",
                   "success"
               );
               $("#client_form").submit();
           }
