        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
          ...
          <div class="d-flex align-items-baseline flex-wrap mr-5">
            ...
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
              ...
              <li class="breadcrumb-item text-muted">
                <a href="" class="text-muted">Add Status</a>
              </li>
            </ul>
            <!--end::Breadcrumb-->
          </div>
        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">Status Add Form
                <i class="mr-2"></i>
          ...
          <!--begin::Form-->
            {{ Form::open([ 'route' => 'statuses.store','class'=>'form' ,"id"=>"client_add_form", 'enctype'=>'multipart/form-data']) }}
              @csrf
              <div class="row">
                ...
                <div class="col-xl-8">
                  <div class="my-5">
                    ...
                    <div class="form-group row {{ $errors->has('sort_order') ? 'has-error' : '' }}">
                      ...
                      <div class="col-9">
                        {{ Form::number('sort_order', null, ['class' => 'form-control form-control-solid','id'=>'name','placeholder'=>'Enter Here','required'=>'true']) }}
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-3">
                         <span class="switch switch-outline switch-icon switch-success">
                          <label><input type="checkbox"  id="active" name="complete" value="1">
                            <span></span>
                          </label>
                        </span>
                          </div>
