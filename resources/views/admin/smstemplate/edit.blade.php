        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">SMS Template
                <i class="mr-2"></i>
            ...
            <div class="card-toolbar">
              ...
              <div class="btn-group">
                <a href=""  onclick="event.preventDefault(); document.getElementById('template_update_form').submit();" id="kt_btn" class="btn btn-primary font-weight-bolder">
          ...
          <!--begin::Form-->
            {{ Form::model($template, [ 'method' => 'PATCH','route' => ['templates.update', $template->id],'class'=>'form' ,"id"=>"template_update_form", 'enctype'=>'multipart/form-data'])}}
              @csrf
              <div class="row">
                  ...
                  <div class="my-5">
                    <div class="form-group row {{ $errors->has('title') ? 'has-error' : '' }}">
                      ...
                      <div class="form-group row {{ $errors->has('type') ? 'has-error' : '' }}">
                        ...
                        <div class="col-9">
                            <select class="form-control  select-2-multiple" name="type" id="type" >
                                <option value="1" @if($template->type == '1') selected @endif>Invoice</option>
                                <option value="2" @if($template->type == '2') selected @endif >Wel Come Client </option>
                                <option value="3" @if($template->type == '3') selected @endif>Enquiries</option>
                            </select>
                      ...
                      <div class="form-group row {{ $errors->has('sms_template_id') ? 'has-error' : '' }}">
                          ...
                          <div class="col-9">
                              {{ Form::text('sms_template_id', null, ['class' => 'form-control form-control-solid','id'=>'sms_template_id','placeholder'=>'Enter SMS P-Id','required'=>'true']) }}
                      ...
                      <div class="form-group row {{ $errors->has('sms_template') ? 'has-error' : '' }}">
                          ...
                          <div class="col-9">
                            <textarea class="form-control form-control-solid" name="sms_template" placeholder="Enter Sms Template">{{ $template->description }}</textarea>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-3">
                               <span class="switch switch-outline switch-icon switch-success">
                                <label><input type="checkbox" @if($template->shared)  checked="checked" @endif id="shared" name="shared" value="1">
                                  <span></span>
                                </label>
                              </span>
                        </div>
