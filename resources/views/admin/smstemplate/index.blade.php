...
<div class="card card-custom">
   <div class="card-header">
      <div class="card-title">
         ...
         <h3 class="card-label">SMS Tempalates</h3>
            {{--  @if(auth()->user()->role == '1')
      ...
      <div class="card-toolbar">
         ...
         <a href="{{ route('templates.create') }}" class="btn btn-primary font-weight-bolder mr-2">
   ...
   <div class="card-body">
      ...
      <div class="table-responsive">
         <form action="{{route('admin.delete-selected-templates')}}" method="post" id="template_form">
...
<script>
   ...
   function viewInfo(id) {
       ...
       $.post("{{ route('admin.getTemplate') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
   ...
   function view_used(id) {
    ...
    var CSRF_TOKEN = '{{ csrf_token() }}';
    $.post("{{ route('admin.getUsed') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
        $('.modal-body').html(response);
        $('#payModel').modal('show');
   ...
   function del(id){
       ...
       icon: "warning",
           ...
           if (result.value) {
               ...
               window.location.href = APP_URL+"/admin/template/delete/"+id;
           }
       });
   }
