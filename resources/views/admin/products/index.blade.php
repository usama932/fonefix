...
<div class="card card-custom ">
   <div class="card-header">
      ...
      <div class="card-toolbar">
         ...
         $add = $user->permission->product_add;
         }
         @endphp
         @if($add)
         <!--begin::Button-->
         ...
         <a href="{{ route('products.create') }}" class="btn btn-primary font-weight-bolder mr-2">
         ...
         @endif
         <div class="btn-group">
            <a href="{{ route('product-import') }}"  class="btn btn-success font-weight-bolder">
            <i class="fa fa-file-import icon-sm"></i>Import</a>
            <a href="{{ route('product-export') }}"  id="kt_btn" class="btn btn-primary font-weight-bolder">
   ...
   <div class="card-body">
      ...
      <div class="">
         <form action="{{route('admin.delete-selected-products')}}" method="post" id="client_form">
