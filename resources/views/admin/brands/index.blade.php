...
<div class="card card-custom">
   <div class="card-header">
      <div class="card-title">
         ...
         <h3 class="card-label">Brands List</h3>
            @if(auth()->user()->role == '1')
      ...
      <div class="card-toolbar">
         ...
         @if($add)
         <a href="{{ route('brands.create') }}" class="btn btn-primary font-weight-bolder mr-2">
         ...
         <div class="btn-group">
            <a href="{{ route('brand-import') }}"  class="btn btn-success font-weight-bolder">
            <i class="fa fa-file-import icon-sm"></i>Import</a>
            <a href="{{ route('brand-export') }}"  id="kt_btn" class="btn btn-primary font-weight-bolder">
...
<script>
   ...
   function viewInfo(id) {
       ...
       $.post("{{ route('admin.getBrand') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
   ...
   function del(id){
       ...
       icon: "warning",
           ...
           if (result.value) {
               Swal.fire(
                   "Deleted!",
                   "Your brands has been deleted.",
                   "success"
               );
               var APP_URL = {!! json_encode(url('/')) !!}
               window.location.href = APP_URL+"/admin/brand/delete/"+id;
           }
       });
   }
