        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">Device Edit Form
                <i class="mr-2"></i>
          ...
          <!--begin::Form-->
            {{ Form::model($user, [ 'method' => 'PATCH','route' => ['devices.update', $user->id],'class'=>'form' ,"id"=>"client_update_form", 'enctype'=>'multipart/form-data'])}}
              @csrf
              <div class="row">
                      ...
                      <div class="form-group row {{ $errors->has('type') ? 'has-error' : '' }}">
                          ...
                          <div class="col-9">
                              <select name="type" class="form-control" id="">
                                  <option value="1" @if($user->type == 1) selected @endif>Mobile</option>
                                  <option value="2" @if($user->type == 2) selected @endif>Laptop</option>
                              </select>
                          </div>
                      </div>
