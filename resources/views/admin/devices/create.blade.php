          ...
          <div class="d-flex align-items-baseline flex-wrap mr-5">
            ...
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
              <li class="breadcrumb-item text-muted">
                <a href="" class="text-muted">Manage Devices</a>
              </li>
              <li class="breadcrumb-item text-muted">
                <a href="" class="text-muted">Add Device</a>
              </li>
            </ul>
            <!--end::Breadcrumb-->
          </div>
        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">Device Add Form
                <i class="mr-2"></i>
            ...
            <div class="card-toolbar">
              ...
              <a href="{{ route('devices.index') }}" class="btn btn-light-primary
              font-weight-bolder mr-2">
                <i class="ki ki-long-arrow-back icon-sm"></i>Back</a>

              <div class="btn-group">
                <a href="{{ route('devices.store') }}"  onclick="event.preventDefault(); document.getElementById('client_add_form').submit();" id="kt_btn" class="btn btn-primary font-weight-bolder">
          ...
          <!--begin::Form-->
            {{ Form::open([ 'route' => 'devices.store','class'=>'form' ,"id"=>"client_add_form", 'enctype'=>'multipart/form-data']) }}
              @csrf
              <div class="row">
                ...
                <div class="col-xl-8">
                  ...
                  <div class="form-group row {{ $errors->has('pre_repair') ? 'has-error' : '' }}">
                      <label class="col-3">Pre Repair</label>
                      <div class="col-9">
                          {{ Form::textarea('pre_repair', null, ['class' => 'form-control form-control-solid','id'=>'name','placeholder'=>'Enter Here','required'=>'true']) }}
                          <span class="text-danger">{{ $errors->first('pre_repair') }}</span>
                      </div>
                  </div>
                  </div>
