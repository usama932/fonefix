...
{{--                </div>--}}
            ...
            <div class="card-toolbar">
                ...
                <!--begin::Button-->
                <a href="{{ route('sliderImages.create') }}" class="btn btn-primary font-weight-bolder">
...
@section('scripts')
    ...
    <script>
        ...
        var sliderImage = $('#sliderImage').DataTable({
            "order": [
                [1, 'asc']
            ],
            "processing": true,
            ...
            "responsive": true,
            "ajax": {
                "url": "{{ route('admin.get-sliderImages') }}",
                "dataType": "json",
                "type": "POST",
                "data": {
        ...
        function del(id) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    window.location.href = APP_URL + "/sliderImage/delete/" + id;
                }
            });
        }
