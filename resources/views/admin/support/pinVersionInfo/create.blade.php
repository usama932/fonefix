...
@section('content')
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <!--begin::Subheader-->
        <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader" kt-hidden-height="54"
             style="">
            <div
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            <li class="breadcrumb-item text-muted">
                                <a href="" class="text-muted">Manage Pin version Info</a>
                            </li>
                            <li class="breadcrumb-item text-muted">
                                <a href="" class="text-muted">Add Version info</a>
                            </li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                ...
                <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                    <div class="card-header" style="">
                        <div class="card-title">
                            <h3 class="card-label">pin versionInfo Add Form
                                <i class="mr-2"></i>
              ...
              font-weight-bolder mr-2">
                    ...
                    <!--begin::Form-->
                        <div class="row">
                            ...
                            <div class="col-xl-8">
                                <div class="my-5">
                                    {{ Form::open([ 'route' => 'pinVersionInfo.store','class'=>'form' ,"id"=>"versionInfo_add_form", 'enctype'=>'multipart/form-data']) }}
                                    @csrf
                                    <!-- <div
                                        class="form-group row {{ $errors->has('Version #') ? 'has-error' : '' }}">
                                        <label class="col-3">version #</label>
                                        <div class="col-9">
                                            {{ Form::text('version', null, ['class' => 'form-control form-control-solid','id'=>'version','placeholder'=>'Enter Version #','required'=>'true']) }}
                                    ...
                                    <div
                                        ...
                                        <div class="col-9">
                                            ...
                                            <span class="text-danger">{{ $errors->first('descripption') }}</span>
                                        </div>
                                    </div>
    ...
    function validated() {
        ...
        if ($('#versionInfo_add_form').valid()) // check if form is valid
        {
            $("#versionInfo_add_form").submit();
        } else {
            return;
        }
    }
