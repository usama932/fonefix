  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Countries List</h3>
    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
	      <form action="{{route('admin.delete-selected-countries')}}" method="post" id="client_form">
		  ...
		  <div class="modal-dialog modal-dialog-centered" role="document">
			  <div class="modal-content">
				  <div class="modal-header">
					  ...
					  <h4 class="modal-title" id="myModalLabel">Countries Detail</h4> </div>
...
@section('scripts')
  ...
  <script>
      ...
      function viewInfo(id) {
          ...
          $.post("{{ route('admin.getCountry') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
      ...
      function del_selected(){
          Swal.fire({
              ...
              if (result.value) {
                  Swal.fire(
                      "Deleted!",
                      "Your Countries has been deleted.",
                      "success"
                  );
                  $("#client_form").submit();
              }
