					...
					<div class="d-flex align-items-baseline flex-wrap mr-5">
						...
						<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
							<li class="breadcrumb-item text-muted">
								<a href="" class="text-muted">Other Setting</a>
							</li>
						</ul>
						<!--end::Breadcrumb-->
					</div>
				...
				<div class="card card-custom card-sticky" id="kt_page_sticky_card">
					<div class="card-header" style="">
						<div class="card-title">
							<h3 class="card-label">Other Setting
								<i class="mr-2"></i>
							...
							<div class="btn-group">
                                @php
                                    ...
                                    if($user->role == 1){
                                        ...
                                        $add = $user->permission->setting_other_edit;
                                    }
                                @endphp
                                @if($add)
					...
					@include('admin.partials._messages')
						<!--begin::Form-->
						<form class="form" id="setting_form" method="POST" action="{{ route('other-setting.store') }}" enctype='multipart/form-data'>
							@csrf
							<div class="row">
