        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">Information Edit Form
                <i class="mr-2"></i>
          ...
          <!--begin::Form-->
            {{ Form::model($information, [ 'method' => 'PATCH','route' => ['informations.update', $information->id],'class'=>'form' ,"id"=>"client_update_form", 'enctype'=>'multipart/form-data'])}}
              @csrf
              <div class="row">
                          ...
                          <div class="col-9">
                              <select class="form-control form-control-solid" id="myDropdown" multiple  name="shops[]" >
                                  ...
                                  @foreach ($shops as $shop)
                                      <option  class="form-control form-control-solid" value="{{ $shop->id }}"   {{ in_array($shop->name, $users)
                                        ? 'selected'
                                        : '' }}>{{ $shop->name }}</option>
                                  @endforeach
                              </select>
