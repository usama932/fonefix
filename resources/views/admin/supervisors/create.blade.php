    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                                ...
                                <div class="col-sm-6">
                                    <ol class="breadcrumb float-sm-right">
                                        ...
                                        <a class="btn btn-info btn-sm"
                                           href="{{ route('supervisors.store') }}"
                                           onclick="event.preventDefault(); document.getElementById('supervisor_add_form').submit();"
                                           id="kt_btn">
                ...
                <!--begin::Form-->
                    {{ Form::open([ 'route' => 'supervisors.store','class'=>'form' ,"id"=>"supervisor_add_form", 'enctype'=>'multipart/form-data']) }}
                    @csrf
                    <div class="row">
