        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          ...
          @php
              ...
              if($us->role == 1){
                  ...
                  $user_enable = $us->permission->user_enable;
              }
          @endphp
          <!--begin::Form-->
                ...
                <div class="col-xl-8">
                  <div class="my-5">
                              ...
                              <table class="table table-striped mt-5">
                                  ...
                                  @foreach($user->brands as $brand)
                                      <tr>
                                          ...
                                          <td>
                                              <a href="{{route("delete-user-brand",$brand->id)}}"><i class="fa fa-trash-alt  btn btn-outline-danger float-right btn-sm mb-2"></i></a>
                                          </td>
                                      </tr>
                                  @endforeach
                              </table>
                    ...
                    <div class="form-group row {{ $errors->has('password') ? 'has-error' : '' }}">
                      <label class="col-3">ID Cards</label>
                      <div class="col-9">
                    ...
                    <div class="form-group row {{ $errors->has('password') ? 'has-error' : '' }}">
                      ...
                      <div class="form-group row" @if(!$user_enable) style="display: none" @endif>
