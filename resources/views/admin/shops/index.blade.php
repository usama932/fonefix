  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Shop List</h3>
      ...
      <div class="card-toolbar">
        ...
        <!--begin::Button-->
        <a href="{{ route('shops.create') }}" class="btn btn-primary  mr-2 font-weight-bolder">
              ...
              <div class="btn-group">
                  <a href="{{ route('shop-import') }}"  class="btn btn-success  font-weight-bolder">
                      <i class="fa fa-file-import icon-sm"></i>Import</a>
                  <a href="{{ route('shop-export') }}"  id="kt_btn" class="btn btn-primary font-weight-bolder">
    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
	      <form action="{{route('admin.delete-selected-shops')}}" method="post" id="client_form">
		  ...
		  <div class="modal-dialog modal-dialog-centered" role="document">
			  <div class="modal-content">
				  <div class="modal-header">
					  ...
					  <h4 class="modal-title" id="myModalLabel">Shop Detail</h4> </div>
...
@section('scripts')
  ...
  <script>
      ...
      function viewInfo(id) {
          ...
          $.post("{{ route('admin.getStaff') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
      ...
      function del(id){
          ...
          icon: "warning",
              ...
              if (result.value) {
                  ...
                  window.location.href = APP_URL+"/admin/shop/delete/"+id;
              }
          });
      }
