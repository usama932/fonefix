                    ...
                    <div class="d-block w-100" data-toggle="">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <h1 class="create_article_box_title">Edit Folder</h1>
                                </div>
                                <div class="col-sm-6">
                    ...
                    <div id="collapseNine" class="" data-parent="#">
                        <div class="card-body">
                            <div class="info">
                                ...
                                {{ Form::model($user, [ 'method' => 'PATCH','route' => ['folders.update', $user->id],'class'=>'form' ,"id"=>"folder_update_form", 'enctype'=>'multipart/form-data'])}}
                                @csrf
...
<script >
   ...
   function validated(){
       ...
       if ($('#folder_update_form').valid()) // check if form is valid
       {
           $("#folder_update_form").submit();
       }
       else 
       {
           return;
