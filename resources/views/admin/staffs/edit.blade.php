        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">Staff Edit Form
                <i class="mr-2"></i>
                </h3>
          ...
          <!--begin::Form-->
            {{ Form::model($user, [ 'method' => 'PATCH','route' => ['staffs.update', $user->id],'class'=>'form' ,"id"=>"client_update_form", 'enctype'=>'multipart/form-data'])}}
              @csrf
              <div class="row">
                  ...
                  <div class="my-5">
                    ...
                    <div class="form-group row {{ $errors->has('password') ? 'has-error' : '' }}">
                      ...
                      <div class="form-group row {{ $errors->has('role') ? 'has-error' : '' }}">
                          ...
                          <div class="col-9">
                              {{ Form::select('role',$roles, $user->role_id, ['class' => 'no-padding form-control col-lg-12','id'=>'brand']) }}
