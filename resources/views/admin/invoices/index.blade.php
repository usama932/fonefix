...
<div class="card card-custom">
   <div class="card-header">
      ...
      <div class="card-toolbar">
         @php
            ...
            $add = $user->permission->invoice_add;
            }
         @endphp
         @if($add)
         <!--begin::Button-->
         <a href="{{ route('invoices.create') }}" class="btn btn-primary font-weight-bolder">
   ...
   <div class="card-body">
      ...
      <div class="table-responsive">
         <form action="{{route('admin.delete-selected-invoices')}}" method="post" id="client_form">
   ...
   function del(id){
       ...
       icon: "warning",
           ...
           if (result.value) {
               ...
               window.location.href = APP_URL+"/admin/invoice/delete/"+id;
           }
       });
   }
