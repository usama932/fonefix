        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">Whatsapp Template
                <i class="mr-2"></i>
          ...
          <!--begin::Form-->
            {{ Form::model($template, [ 'method' => 'PATCH','route' => ['whatsapp.update', $template->id],'class'=>'form' ,"id"=>"template_update_form", 'enctype'=>'multipart/form-data'])}}
              @csrf
              <div class="row">
                  ...
                  <div class="my-5">
                    <div class="form-group row {{ $errors->has('title') ? 'has-error' : '' }}">
                      ...
                      <div class="form-group row {{ $errors->has('sms_template') ? 'has-error' : '' }}">
                          ...
                          <div class="col-9">
                            <textarea class="form-control form-control-solid" name="sms_template" placeholder="Enter Whatsapp Template">{{ $template->description }}</textarea>
