  ...
  <div class="card card-custom">
    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
	      <form action="{{route('admin.delete-selected-roles')}}" method="post" id="client_form">
		  ...
		  <div class="modal-dialog modal-dialog-centered" role="document">
			  <div class="modal-content">
				  <div class="modal-header">
					  ...
					  <h4 class="modal-title" id="myModalLabel">Role Detail</h4> </div>
...
@section('scripts')
  ...
  <script>
      ...
      function viewInfo(id) {
          ...
          $.post("{{ route('admin.getRole') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
