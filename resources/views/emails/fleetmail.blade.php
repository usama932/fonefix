                            ...
                            <table border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        <p style="font-family: sans-serif; font-size: 24px; font-weight: normal; margin: 0; Margin-bottom: 5px;"><span>Title : <strong>{{$data['name'] }}</strong></span></p>
{{--                                        <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 5px;"><span>Subject : <strong>{{$data['subject']}}</strong></span></p>--}}
                                        <table border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td style="text-align:left">
                                    ...
                                    <p style="font-size:16px; color:#2e2e2e; line-height:25px; margin:0px; padding-top:20px;">
                                        You have received a new Support Message ,you have add fleet ticket .Below are the details:</p>
                                    <p style="font-size:16px; color:#2e2e2e; line-height:25px; margin:0px; padding-top:20px;">
