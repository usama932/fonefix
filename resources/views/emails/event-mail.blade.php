                ...
                <tr>
                    <td>
                        <table>
                            ...
                            <tr style="text-align:center;margin-top:15px;">                            </tr>
                            <tr>
                                <td style="text-align:left">
                                    <p style="font-size:18px; color:#2e2e2e; line-height:25px; margin:0px; padding-top:20px;">Hello {{ $data['name'] }},</p>
                                    ...
                                    <p style="font-size:16px; color:#2e2e2e; line-height:25px; margin:0px; padding-top:20px;">
                                        ...
                                        <br>
                                        <span>Email : <strong>{{$data['user_email']}}</strong></span>
                                        <br>
