        ...
        <td class="container"
            ...
            <div class="content"
                ...
                <table class="main"
                    ...
                    <tr>
                        <td class="wrapper"
                            style="border-bottom: 1px solid #d9d9d9; font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px;">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        <p style="font-family: sans-serif; font-size: 24px; font-weight: normal; margin: 0; Margin-bottom: 5px;"><span>Title : <strong>{{$article->title}}</strong></span></p>
                                        <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 5px;"><span>Category : {!! $article->categories->name!!}</span></p>
                                        <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 5px;"><span>Content : {!! $article->content !!}</span></p>
{{--                                        <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 5px;"><span>Subject : <strong>{{$subject}}</strong></span></p>--}}
                                        <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><span>Date : {{$article->created_at}}</span></p>
{{--                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">{{$article->content}}</p>--}}
                                        <table border="0" cellpadding="0" cellspacing="0"
                                               style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; box-sizing: border-box; margin-top: 25px;">
                                            <tbody>
                                            <tr>
                                                <td align="left"
                                                    style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                                        ...
                                                        <tr>
                                                            <td style="vertical-align: top;text-align: center; max-width: 100%;">
                                                                <div class="form-group row">
                                                                    @php $c_images = \App\Models\ArticleImage::where([["type",1],["article_id",$article->id]])->get();  @endphp
                                                                    @foreach($c_images as $image)
                                                                        <img src="{{asset('uploads/'.$image->image)}}"
                                                                             style="width:40%;"
                                                                             alt="Image is not found."/>
                                                                        <?php $serviceId = $article->id; $imageId = $image->id?>
                                                                    @endforeach
                                                                </div>
                                                            </td>
                                                        </tr>
...
{{--<table width="100%" cellspacing="50" cellpadding="50" border="0" bgcolor="#E7E7E7" class="wrapper">
    ...
    <tr>
        <td>
            <table bgcolor="#ffffff" cellpadding="0" cellspacing="0" align="center"
                   style="border:1px solid #acacac; border-radius:4px; padding:20px 50px 100px; width:632px;">
                <tr>
                    <td>
                        <table>
                            <tr>
                                <td style="text-align:left"><h1
                                        style="font-weight:normal; color:#2e2e2e; font-size:30px; margin:0px; padding-top:60px;">
                                        Support Message!</h1>
