...
@include('user.partials._page-loader')
@include('user.layouts.layout')
@include('user.partials._extras.offcanvas.quick-user')
@include('user.partials._extras.scrolltop')
@include('user.partials._extras.toolbar')
@include('user.partials._extras.offcanvas.demo-panel')
