...
class SettingController extends Controller
{
    ...
    {
        $settings = Setting::where("type", 1)->get()->pluck('value','name');
        $all_columns =array(
            array(
                'name'=>'site_title',
                'id'=>'site_title',
        ...
        return view('admin.settings.index', ['title' => 'Basic Setting','settings'=>$settings,
    ...
    {
        $input = $request->all();
        $settings = Setting::where("type", 1)->get();
...
//        DB::table('settings')->truncate();
        $delete = Setting::where("type",1)->get();
